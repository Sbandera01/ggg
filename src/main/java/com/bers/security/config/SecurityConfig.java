...
public class SecurityConfig {
    ...
    // Endpoints públicos sin patrones con {id}
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/tickets/**").hasAnyRole("CLERK", "ADMIN")
                        .requestMatchers("/api/v1/baggage/**").hasAnyRole("CLERK", "ADMIN")
                        .requestMatchers("/api/v1/parcels/**").hasAnyRole("CLERK", "ADMIN")
                        .requestMatchers("/api/v1/seat-holds/**").hasAnyRole("CLERK", "ADMIN")
